...
<template>
	<AppLayout>
		<Head title="Create New Collection" />
		...
		<div class="flex justify-between mb-10">
			<div class="text-3xl text-black uppercase font-black">
				Create new <span class="text-primary">Collection</span>
			</div>
		</div>

		<div class="bg-white w-full p-8 grid grid-cols-2 gap-y-4 gap-x-8 mb-10">
		...
		<Fields :fields="form.fields"> </Fields>
	</AppLayout>
</template>
