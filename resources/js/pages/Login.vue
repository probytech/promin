...
<template>
	<AuthLayout>
		...
		<form
			...
			class="bg-white py-12 px-8 md:px-24 flex flex-col items-center rounded-2xl"
		>
			<svg
			...
			<h1 class="text-4xl font-inter font-black uppercase mb-4 text-center">
				<span class="text-primary">Welcome</span> back
			</h1>
